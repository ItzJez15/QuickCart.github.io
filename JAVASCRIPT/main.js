...
const anchors = document.querySelectorAll('#fashion-banner a[href]');
let currentImage = 0;
...
function changeImage() {
    ...
    // Update the href of the active anchor
    ...
    anchors[0].href = images[0].classList.contains('active') ? 'NewArrivals.html' : 'SpringSale.html';
    anchors[1].href = images[1].classList.contains('active') ? 'SpringSale.html' : 'NewArrivals.html';
}

window.onload = function() {
    images[currentImage].classList.add('active');
    anchors[currentImage].classList.add('active-anchor'); //set the initial active anchor.

    setTimeout(changeImage, 100); // give 1 second delay.
